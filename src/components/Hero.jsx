    ...
    return (
        <div>
            ...
            <div className="w-full text-black flex flex-col  h-1/2 items-center">
               ...
               <Link to={"/solana"}> <button className="bg-blue-100 text-blue-600 font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-gray-100 transition duration-300">Solana</button> </Link>
               <Link to={"/ethereum"}> <button  className="bg-blue-100 text-blue-600 font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-gray-100 transition duration-300">Ethereum</button></Link>
                </div>
            </div>
